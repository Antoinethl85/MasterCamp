...
contract WorkVote is ERC721 {
    ...
    function id_in_list(uint256 _id, uint256[] memory _list) public returns (bool){
        bool _temp = false;
    ...
    function find_index(uint256 _token_id, uint256[] memory _tokens) public returns (uint){
        uint index;
